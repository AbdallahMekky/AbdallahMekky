I’ve been building for the web since the days of table layouts and blinking `<marquee>`s. From WordPress and Laravel to Angular v2 and now React, I’ve grown with the web — and never stopped learning.
